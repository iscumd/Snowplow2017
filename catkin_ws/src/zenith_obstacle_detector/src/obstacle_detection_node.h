...
#include "zenith_obstacle_detector/SegmentObstacle.h"
#include "zenith_obstacle_detector/Obstacles.h"
...
private:
    ...
    std::list<zenith_obstacle_detector::SegmentObstacle> segments_;
};
